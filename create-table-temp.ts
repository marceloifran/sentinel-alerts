--Script to create obligation_notifications table
--This will be executed via Supabase client
...
async function createNotificationsTable() {
    ...
    create policy if not exists "Responsables can view their obligation notifications"
      on public.obligation_notifications
      for select
      to authenticated
      using (
    ...
    drop trigger if exists enforce_notification_limit on public.obligation_notifications;
